...
<div class="container">
	<div class="sub_content sights_wrap pb-4">
				...
				success: function(data) {
					...
					$.each(data, function(index, value) {
						...
						$.each(value.dataList, function(idx, val) {
							html+= '		  <div class="list_item image_data" data-view="' + val.dataNo + '">';
							html+= '    		<div class="image_area">';
							html+= '   				<img src="${pageContext.request.contextPath}/resources/images/data/view_' + val.dataImage + '.jpg">';
