			...
			<div class="container">
				<div class="banner_content">
					<div class="banner_layer main_title">
						<img src="${pageContext.request.contextPath }/resources/images/text/txt_banner_sub.png" />
					</div>
				</div>
				
				<div class="banner_content banner_content_mobile d-none">
					<div class="banner_layer main_title">
						<img src="${pageContext.request.contextPath }/resources/images/text/txt_banner_sub_m.png" />
					</div>
				</div>
			</div>
		</div>
